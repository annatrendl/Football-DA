...
When the England football team wins in national football tournament, there is a 61\% increase in reported alcohol-related domestic abuse. This is a large increase, translating into a 0.43 increase in the daily rate of alcohol-related cases per 100,000 individuals against a base rate 0.71 cases per 100,000. This effect is entirely limited to alcohol-related abuse, even though alcohol-related domestic abuse cases are only 23\% of all domestic abuse in our dataset. As such, we see this as strong quantitative evidence that alcohol plays an instrumental role in the relationship between football and domestic abuse in England. The effect is also exclusively limited to male-perpetrated domestic abuse, implicating masculinity and alcohol consumption as the pathway by which football increases abuse.
...
%  &  &  &  & (0.083) & (0.097) & (0.067) & (0.059) & (0.062) \\ 
  ...
  England loss:AlcoholYes &  &  &  & 0.748$^{**}$ & 0.301 & 0.048 & $-$0.289 & 0.160 \\ 
...
%Alcohol & $-$0.862$^{***}$ & $-$0.862$^{***}$ & $-$0.862$^{***}$ & $-$0.863$^{***}$ & $-$0.867$^{***}$ \\ 
 ...
 \hline \\[-1.8ex] 
Number of days & 5,416 & 5,302 & 5,304 & 5,302 & 5,304 \\ 
...
\centering
 \scalebox{0.85}{
  \begin{threeparttable}
 \caption{The effect of England rugby matches on domestic abuse}
  \label{rugby}
...
\cline{2-2} 
\\[-1.8ex] & Number of reported domestic abuse cases per day \\ 
\hline \\[-1.8ex] 
% Alcohol & $-$0.862$^{***}$ \\ 
%  & (0.031) \\ 
  Tournament on & 0.005 \\ 
