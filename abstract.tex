...
%In general, British football fandom is characterised by a high level of team identification and is prevalently male dominated\autocite{Parry2014}.
...
\scalebox{0.9}{
  ...
  \caption{Number of reported domestic abuse incidents by type of day and gender of perpetrator and victim} 
...
%\cline{2-4} 
%\\[-1.8ex] & \multicolumn{3}{c}{da\_count} \\ 
...
\begin{table}
\centering
 \caption{Robustness of the result}
 \scalebox{0.75}{
 \label{robustness}
...
\hline \\[-1.8ex] 
 & \multicolumn{3}{c}{\textit{Dependent variable:}} \\ 
\cline{2-4} 
\\[-1.8ex] & Domestic\_Abuse & Sexual & OtherAbuse \\ 
\\[-1.8ex] & (1) & (2) & (3)\\ 
\hline \\[-1.8ex] 
