...
We have found that when England wins, there is a 67\% increase in domestic abuse---but only male-on-female abuse involving alcohol. The effect lasts for about 3-6 hours after the match. An increase is also seen in other violent crimes, predominantly those perpetrated by men on women. The effect is specific to football, but not rugby. The peculiar specificity of the effect will be useful in understanding the causes of abuse. 

\NS{Given it is very hard to think of some other event that happens only on the win days, can we make a causal argument? And can we extend that to the effect of alcohol?}
